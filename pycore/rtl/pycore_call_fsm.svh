...
//   19 : EX_EXPAND — push args elements onto stack → join CALL
                ...
                S_CALL: begin
                    ...
                    unique case (call_phase_r)
                        ...
                        5'd0: begin
                            if (call_mode_r == CALL_MODE_KW) begin
                                ...
                                call_tos_base_r   <= RF_AW'(
                                    {1'b0, tos_r} - {1'b0, cur_arg_r[7:0]} - 9'd2);
                                container_rf_addr_r <= RF_AW'(
                                    {1'b0, tos_r} - {1'b0, cur_arg_r[7:0]} - 9'd2);
                                call_phase_r <= 5'd1;
                            end
                        ...
                        5'd1: begin
                            ...
                            if (cont_rf_rs1_tag == PY_TAG_CODE_OBJECT) begin
                                ...
                                if (pycore_is_stracc_method_code(
                                    ...
                                    container_rf_addr_r <= RF_AW'(
                                        {1'b0, tos_r} - {1'b0, cur_arg_r[7:0]} - 9'd1);
                                    call_phase_r        <= 5'd2;
                                end
                        ...
                        4'd7: begin
                            if (!rf_spill_needed_r && (rf_spill_n_comb != 17'd0) &&
                                    !call_sent_r) begin
                                rf_spill_needed_r <= 1'b1;
                                rf_spill_left_r   <= rf_spill_n_comb[8:0];
                            end else if (!rf_spill_needed_r &&
                                         !call_sent_r && !frame_busy) begin
                            ...
                            if (frame_init_new_frame) begin
                                ...
                                if ((call_nlocals_r - call_argcount_r) >
                                        16'(RF_INIT_CHUNK)) begin
                                    rf_init_more_r <= 1'b1;
                                    rf_init_next_r <= call_argcount_r[RF_AW-1:0]
                                                      + RF_AW'(RF_INIT_CHUNK);
                                end
                                tos_r                <= frame_next_locals_base
                                                        + call_nlocals_r[RF_AW-1:0];
                                call_sent_r          <= 1'b0;
                                frame_dmem_pending_r <= 1'b0;
...
//   else: marshal PY_TRAP_BUILTIN_CALL
                        ...
                        4'd13: begin
                            unique case (call_sub_r)
                                ...
                                6'd4: begin
                                    ...
                                    container_rf_addr_r <= RF_AW'({1'b0, tos_r} - 9'd1);
                                    call_sub_r          <= 6'd5;
                                end
                                6'd5: begin
                                ...
                                // 60: _bi_code_alloc(nslots) -> INT base
                                6'd60: begin
                                    if (cont_rf_rs1_tag != PY_TAG_INT) begin
                                        call_filter_trap_r <= 1'b1;
                                    end else if (cont_rf_rs1_val[127] ||
                                                 (cont_rf_rs1_val[31:0] == 32'd0) ||
                                                 (cont_rf_rs1_val[126:32] != 95'b0)) begin
                                        container_type_trap_r <= 1'b1;
                                    end else if (({1'b0, code_ram_ptr_r} +
                                                  {1'b0, cont_rf_rs1_val[31:0]}) >
                                                 {1'b0, PYCORE_CODE_RAM_SLOT_LIMIT}) begin
                                        container_mem_fault_r <= 1'b1;
                                    end else begin
                                        container_wb_we_r   <= 1'b1;
                                        container_wb_addr_r <= RF_AW'(
                                ...
                                // 61: _bi_code_blit(base, words) -> INT count
                                6'd61: begin
                                    if (code_write_needed_r) begin
                                    end else unique case (code_op_phase_r)
                                        5'd0: begin
                                            if (cont_rf_rs1_tag != PY_TAG_INT) begin
                                                container_type_trap_r <= 1'b1;
                                            end else begin
                                        ...
                                        5'd1: begin
                                            if (!pycore_is_list(
                                                ...
                                                container_dmem_we_r <= 1'b0;
                                                container_dmem_pending_r <= 1'b1;
                                                code_op_phase_r <= 5'd2;
                                            end
                                        end
                                        5'd2: begin
                                            if (!container_dmem_pending_r) begin
                                                code_len_r <= cont_hdr_len[31:0];
                                                container_dmem_addr_r <=
                                                    pycore_list_obitem_addr(
                                                        container_src_buf_r);
                                                container_dmem_we_r <= 1'b0;
                                                container_dmem_pending_r <= 1'b1;
                                                code_op_phase_r <= 5'd3;
                                            end
                                        end
                                        5'd3: begin
                                            if (!container_dmem_pending_r) begin
                                        ...
                                        5'd5: begin
                                            if (!container_dmem_pending_r) begin
                                                if (container_rd_data_r[3:0] !=
                                                        PY_TAG_INT) begin
                                                    container_type_trap_r <= 1'b1;
                                                end else if (container_val_r[63:40] !=
                                                             24'b0) begin
                                                    container_type_trap_r <= 1'b1;
                                                end else if (
                                                    ((container_base_r +
                                                    ...
                                                    code_write_slot_r <=
                                                        ...
                                                        code_idx_r;
                                                    code_write_word_r <=
                                                        container_val_r[63:0];
                                                    code_write_needed_r <= 1'b1;
                                                end
                                            end
                                        end
                                        5'd6: begin
                                            if (code_idx_r == code_len_r) begin
                                                container_wb_we_r   <= 1'b1;
                                                container_wb_addr_r <= RF_AW'(
                                                    {1'b0, tos_r} - 9'd4);
                                                container_wb_data_r <=
                                ...
                                // 62: _bi_code_patch(slot, word) -> None
                                6'd62: begin
                                    if (code_write_needed_r) begin
                                    end else unique case (code_op_phase_r)
                                        5'd0: begin
                                        ...
                                        5'd1: begin
                                            if (cont_rf_rs1_tag != PY_TAG_INT) begin
                                                container_type_trap_r <= 1'b1;
                                            end else if (cont_rf_rs1_val[63:40] !=
                                                         24'b0) begin
                                                container_type_trap_r <= 1'b1;
                                            end else if ((container_base_r <
                                                          code_ram_floor_r) ||
                                                         (container_base_r >=
                                                          PYCORE_CODE_RAM_SLOT_LIMIT)
                                            ) begin
                                ...
                                // 63: _bi_code_new(fields) -> CODE_OBJECT
                                6'd63: begin
                                    unique case (code_op_phase_r)
                                        5'd0: begin
                                            if (!pycore_is_list(
                                                    cont_rf_rs1_tag,
                                                    cont_rf_rs1_val)) begin
                                        ...
                                        5'd2: begin
                                            if (!container_dmem_pending_r) begin
                                                begin
                                                    ...
                                                    new_obj = pycore_heap_place(
                                                        heap_ptr_r,
                                                        PYCORE_CODE_OBJECT_BYTES);
                                                    alloc_end = pycore_heap_end(
                                                        heap_ptr_r,
                                                        PYCORE_CODE_OBJECT_BYTES);
                                                    if (alloc_end >
                                                            PYCORE_HEAP_LIMIT) begin
                                            ...
                                            if (!container_dmem_pending_r) begin
                                                if ((code_idx_r == 32'd0) &&
                                                    (container_rd_data_r[3:0] !=
                                                     PY_TAG_INT)) begin
                                                    container_type_trap_r <= 1'b1;
                                                end else if ((code_idx_r == 32'd0) &&
                                                    ((container_val_r[31:0] <
                                                      code_ram_floor_r) ||
                                                     (container_val_r[31:0] >=
                                                      code_ram_ptr_r))) begin
                                                    container_mem_fault_r <= 1'b1;
                                                end else if ((code_idx_r == 32'd3) &&
                                                    (container_rd_data_r[3:0] !=
                                                     PY_TAG_INT)) begin
                                                    container_type_trap_r <= 1'b1;
                                                end else if (code_idx_r == 32'd3) begin
                                                    code_meta_lo_r <=
                                                        container_val_r[63:0];
                                                    ...
                                                    container_dmem_pending_r <= 1'b1;
                                                    code_op_phase_r <= 5'd3;
                                                end else if ((code_idx_r == 32'd8) &&
                                                    (container_rd_data_r[3:0] !=
                                                     PY_TAG_INT)) begin
                                                    container_type_trap_r <= 1'b1;
                                                end else if (code_idx_r == 32'd8) begin
                                                    container_tag_r <= PY_TAG_INT;
                                                    container_val_r <= {
                                                        46'b0,
                                                        container_val_r[17:2],
                                                        container_val_r[1],
                                                        container_val_r[0],
                                                        code_meta_lo_r
                                                    };
                                                    code_op_phase_r <= 5'd7;
                                                end else if ((code_idx_r == 32'd6) &&
                                                    !pycore_is_dict(
                                                        container_rd_data_r[3:0],
                                        ...
                                        5'd6: begin
                                            if (!container_dmem_pending_r) begin
                                                if ((code_idx_r + 32'd1) == 32'd9) begin
                                                    container_wb_we_r   <= 1'b1;
                                                    container_wb_addr_r <= RF_AW'(
                                                        {1'b0, tos_r} - 9'd3);
                                                    container_wb_data_r <=
                        ...
                        4'd12: begin
                            unique case (call_sub_r)
                                ...
                                // 32: seeded int type — convert one positional arg.
                                6'd32: begin
                                    begin
                                        logic str_ok;
                                        logic [PYCORE_VAL_WIDTH-1:0] str_int;
                                        if (cont_rf_rs1_tag == PY_TAG_INT) begin
                                            container_wb_we_r   <= 1'b1;
                                            container_wb_addr_r <= call_tos_base_r;
                                            container_wb_data_r <=
                                                pycore_make_entry(
                                                    PY_TAG_INT, cont_rf_rs1_val);
                                            tos_r        <= call_tos_base_r
                                                + RF_AW'(1);
                                            fetch_skip_r <= 1'b1;
                                            call_sub_r   <= 6'd0;
                                            ...
                                            pycore_short_str_to_int(
                                                cont_rf_rs1_val, str_ok, str_int);
                                            if (!str_ok) begin
                                                container_type_trap_r <= 1'b1;
                                            end else begin
                                                container_wb_we_r   <= 1'b1;
                                ...
                                unique case (call_sub_r)
                                        ...
                                        begin
                                            ...
                                            if (def_len > meta_ac) begin
                                                ...
                                                if ((call_argcount_r < min_ac) ||
                                                    ...
                                                    call_filter_trap_r <= 1'b1;
                                                end else if (local_slots >
                                                        16'(RF_WINDOW_CAP)) begin
                                                    call_filter_trap_r <= 1'b1;
                                                end else if (rf_call_need >
                                                        16'(RF_WINDOW_CAP)) begin
                                                    call_filter_trap_r <= 1'b1;
                                    ...
                                    6'd21: begin
                                        ...
                                        container_dmem_addr_r <= pycore_tuple_val_addr(
                                            container_base_r, {24'b0, container_idx_r});
                                        container_dmem_we_r      <= 1'b1;
                                        ...
                                        begin
                                            ...
                                            if (def_len > meta_ac) begin
                                                ...
                                                call_filter_trap_r <= 1'b1;
                                                    ...
                                                    local_slots > 16'(RF_WINDOW_CAP)) begin
                                                call_filter_trap_r <= 1'b1;
                                            end else if (rf_call_need >
                                                    16'(RF_WINDOW_CAP)) begin
                                                call_filter_trap_r <= 1'b1;
                        ...
                        CALL_PHASE_EX_EXPAND: begin
                            if (!container_dmem_pending_r) begin
                                unique case (call_sub_r)
                                    ...
                                    6'd1: begin
                                        if (rf_resident >= 9'(RF_DEPTH - 1)) begin
                                            call_filter_trap_r <= 1'b1;
                                        end else begin
                                            container_wb_we_r   <= 1'b1;
                ...
                S_RETURN: begin
                    ...
                    unique case (return_phase_r)
                        ...
                        3'd0: begin
                            ...
                            if (return_after_fill_r && !rf_fill_needed_r) begin
                            ...
                            if (frame_return_done) begin
                                ...
                                begin
                                    logic [8:0] fill_n;
                                    fill_n = rf_fill_n_f(
                                        frame_locals_base_out, rf_wm_r, tos_r);
                                    if (codc_hit) begin
                                    ...
                                    if (fill_n != 9'd0) begin
                                        rf_fill_left_r      <= fill_n;
                                        rf_fill_needed_r    <= 1'b1;
                                        return_after_fill_r <= 1'b1;
                                    end else if (codc_hit) begin
                                        return_phase_r  <= 3'd2;
                                    end else begin
                                        container_dmem_addr_r    <= pycore_code_field_val_addr(
