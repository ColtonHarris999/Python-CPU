...
ROM_NATIVE_METHODS: tuple[tuple[int, str, str], ...] = (
    ...
    (6, "native_method_retired", "native_method_retired"),
    (7, "native_method_retired", "native_method_retired"),
    (8, "native_method_retired", "native_method_retired"),
    (9, "native_method_retired", "native_method_retired"),
