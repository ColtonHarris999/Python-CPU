...
Plan 1 §2.4 and Plan 3 (`planning/native_compiler_full_plan.md`) require a
provenance record for every ported or vendored compiler source.
...
When a firmware file is ported from PyCPython or PyPy, add a row here and a
