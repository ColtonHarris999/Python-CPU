...
| `compile`/`exec`/`eval` plan | `planning/code_loading_bios_tokenizer_plan.md` (Plan 1) then `planning/native_compiler_full_plan.md` (Plan 3: PyCPython oracle + firmware port + self-hosting). Plan 2 is superseded. |
